...
?>
	<div class="list">
		<br><br>
		<center><h1 class="main">Wish List</h1>
		<br><br>
					...
					<table>
						...
						<tr>
							<td><?php $quantity = $row->quantity;?>
								<form action="updateWishListQty" method="post" >
						...
						<tr>
							<td><button class="delete"><?php echo anchor('Product/removeWishedProduct/'.$row->produceCode, 'Remove', 'onclick = "return checkRemove()"'); ?></button> </td>
						</tr>
					</table>
					<br><br>
					<?php
