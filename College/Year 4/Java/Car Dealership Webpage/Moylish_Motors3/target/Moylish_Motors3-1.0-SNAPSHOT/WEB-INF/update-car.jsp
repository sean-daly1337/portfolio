    ...
    <body>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <h1 class="page-title">Update Car</h1>
        ...
        <section class="add-listing-wrapper border-bottom section-bg section-padding-strict">
            <div class="container">
                        ...
                        <div class="atbd_content_module">
                            <div class="atbd_content_module__tittle_area">
                                <div class="atbd_area_title">
                                    <h4><span class="las la-car"></span>Delete Images (If required)</h4>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <c:forEach items="${allImages}" var="image">
                                        <div class="form-group col-lg-6 col-md-6">
                                            <img class="mb-2" width="100%" height="200px" src="<%= getImageUrl%>${image.getID()}" />
                                            <br>
                                            <button type="button" onclick="deleteCarImage(${image.getID()})"> <i class="la la-trash icon-medium"></i></button>
                                        </div>
                                    </c:forEach>
                                </div>
                            </div>
                ...
                <form class="row" action="update-car.jsp" id="updateCarForm" method="POST" enctype="multipart/form-data">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="atbd_content_module">
                            <div class="atbd_content_module__tittle_area">
                                <div class="atbd_area_title">
                                    ...
                                    <div class="form-group col-lg-8 col-md-8">
                                        ...
                                        <div class="select-basic">
                                            <select class="form-control" name="salesmanUsername"  required>
                                                <option value="${selectedCar.getSalesmanUsername()}" selected="selected">${selectedCar.getSalesmanUsername()}</option>
                                    ...
                                    <div class="form-group col-lg-8 col-md-8">
                                        ...
                                        <div class="select-basic">
                                            <select class="form-control" name="previousOwnerUsername"  required>
                                                <option value="${selectedCar.getPreviousOwnerUsername()}" selected="selected">${selectedCar.getPreviousOwnerUsername()}</option>
                            ...
                            <div class="atbdb_content_module_contents">
                                <div class="row">
                                    <div class="form-group col-lg-6 col-md-6">
                                        ...
                                        <input type="number" name="listing" value="${selectedCar.getListing()}"  class="form-control" placeholder="Enter Listing Number"  readonly>
                                    </div>
                                    <div class="form-group col-lg-6 col-md-6">
                                        <label for="title" class="form-label">Registration</label>
                                        <input type="text" name="reg" class="form-control" value="${selectedCar.getReg()}" placeholder="Enter Registration"  required>
                                    </div>
                                    <div class="form-group col-lg-6 col-md-6">
                                        <label for="title" class="form-label">Year</label>
                                        <input type="text" name="year" class="form-control" value="${selectedCar.getYear()}" placeholder="Enter Year"  required>
                                    </div>
                                    <div class="form-group col-lg-6 col-md-6">
                                        <label for="title" class="form-label">Make</label>
                                        <input type="text" name="make" class="form-control" value="${selectedCar.getMake()}" placeholder="Enter car company"  required>
                                    </div>
                                    <div class="form-group col-lg-6 col-md-6">
                                        <label for="title" class="form-label">Model</label>
                                        <input type="text" name="model" class="form-control" value="${selectedCar.getModel()}" placeholder="Enter car Model"  required>
                                    </div>
                                    <div class="form-group col-lg-6 col-md-6">
                                        <label for="title" class="form-label">Color</label>
                                        <input type="text" name="color" class="form-control" value="${selectedCar.getColor()}" placeholder="Enter car color"  required>
                                    </div>
                                    <div class="form-group col-lg-6 col-md-6">
                                        <label for="desc" class="form-label">Description</label>
                                        <textarea id="desc" name="description" rows="5" class="form-control" value="${selectedCar.getDescription()}" placeholder="Enter car description">
                                            ${selectedCar.getDescription()}
                                        </textarea>
                                    </div>
                                    <div class="form-group col-lg-6 col-md-6">
                                        <label for="title" class="form-label">Buy Price</label>
                                        <input type="number" name="buyPrice" id="buy-price" class="form-control" value="${selectedCar.getBuyPrice()}" placeholder="Enter car price"  required>
                                    </div>
                                    <div class="form-group col-lg-6 col-md-6">
                                        <label for="title" class="form-label">List Price</label>
                                        <input type="number" name="listPrice" id="list-price" class="form-control" value="${selectedCar.getListPrice()}" placeholder="Calulated list price"  readonly>
                                    </div>
                                    <div class="form-group col-lg-6 col-md-6">
                                        <label for="title" class="form-label">Odometer (KPH)</label>
                                        <input type="text" name="odometer" class="form-control" value="${selectedCar.getOdometer()}" placeholder="Enter car Odometer (KPH)"  required>
                                    </div>
                                    <div class="form-group col-lg-6 col-md-6">
                                        <label for="title" class="form-label">0-62 kph</label>
                                        <input type="text" name="kph" class="form-control" value="${selectedCar.getKPH()}" placeholder="Enter seconds"  required>
                                    </div>
                                    <div class="form-group col-lg-6 col-md-6">
                                        <label for="title" class="form-label">Engine</label>
                                        <input type="text" name="engine" class="form-control" value="${selectedCar.getEngine()}" placeholder="Enter Engine"  required>
                                    </div>
                                    <div class="form-group col-lg-6 col-md-6">
                                        <label for="title" class="form-label">Fuel</label>
                                        <div class="select-basic">
                                            <select class="form-control" name="fuel"  required>
                                                <option value="${selectedCar.getFuel()}" selected="selected">${selectedCar.getFuel()}</option>
                                    ...
                                    <div class="form-group col-lg-6 col-md-6">
                                        ...
                                        <div class="select-basic">
                                            <select class="form-control" name="transmission"  required>
                                                <option value="${selectedCar.getTransmission()}" selected="selected">${selectedCar.getTransmission()}</option>
                                    ...
                                    <div class="form-group col-lg-6 col-md-6">
                                        ...
                                        <input type="text" name="body" class="form-control" value="${selectedCar.getBody()}" placeholder="Enter car body"  required>
                                    </div>
                                    <div class="form-group col-lg-6 col-md-6">

                                        <label for="title" class="form-label">Isofix</label>
                                        <div class="select-basic">
                                            <select class="form-control" name="isofax"  required>
                                                <option value="${selectedCar.getIsofix()}" selected="selected">${selectedCar.getIsofix()}</option>
                                    ...
                                    <div class="form-group col-lg-6 col-md-6">
                                        ...
                                        <input type="number" name="tax" class="form-control" value="${selectedCar.getMotorTax()}" placeholder="Enter Motor Tax"  required>
                                    </div>
                                    <div class="form-group col-lg-6 col-md-6">
                                        <label for="title" class="form-label">Previous Owners</label>
                                        <input type="number" name="previousOwners" class="form-control" value="${selectedCar.getPreviousOwners()}" placeholder="Enter count of Previous Owners"  required>
                                    </div>
                                    <div class="form-group col-lg-6 col-md-6">
                                        <label for="title" class="form-label">Full Service History</label>
                                        <div class="select-basic">
                                            <select class="form-control" name="serviceHistory" required>
                                                <option value="${selectedCar.getServiceHistory()}" selected="selected">${selectedCar.getServiceHistory()}</option>
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group col-lg-6 col-md-6">
                                        ...
                                        <input type="text" name="note" class="form-control" value="${selectedCar.getNote()}" placeholder="Enter Note (if any)" >
                                    </div>
                                    ...
                                    <div class="form-group col-lg-6 col-md-6">
                                        ...
                                        <input type="file" name="images" accept="image/*"   multiple="muliple">
                                    </div>
                    ...
                    <div class="col-lg-10 offset-lg-1">
                        <div class="text-center card">
                            <button type="submit" class="btn btn-info">Update Car</button>
                        </div>
                    </div>
