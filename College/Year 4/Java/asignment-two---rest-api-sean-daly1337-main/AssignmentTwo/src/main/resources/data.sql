...
--
 ...
 INSERT INTO Agents (agent_Id, name, phone, fax, email, username, password)
 VALUES
        (1, 'Sue Roberts', '061 451890', '061 451880', 'sue@litrealty.ie', 'Sue.Roberts', 'suepass'),
        (2, 'Natasha Watkins', '061 451891', '061 451881', 'natasha@litrealty.ie', 'Natasha.Watkins', 'natashapass'),
        (3, 'Chris Clarkson', '061 451892', '061 451882', 'chris@litrealty.ie', 'Chris.Clarkson', 'chrispass'),
        (4, 'Laura Blain', '061 451893', '061 451883', 'laura@litrealty.ie', 'Laura.Blain', 'laurapass'),
        (5, 'Dave Lindale', '061 451894', '061 451884', 'dave@litrealty.ie', 'Dave.Lindale', 'davepass');
...
--
 ...
 INSERT INTO garagetypes (garage_Id, g_Type)
 VALUES (1, 'attached'),
        (2, 'detached'),
        (3, 'carport');
...
VALUES (9, '34 Ferndale, Ennis Road', 'Limerick', 443499, 2, 2, 4, 1.5, 1100, 'A3',
       ...
       (5, '79 Hollybrook Grove, Clontarf', 'Dublin 3', 498495, 5, 1, 3, 1, 1900, 'A3',
        ...
        '120x130', 2, 2, 1, '498495.jpg', 123900, '2016-06-02'),
       (3, '12 Killard, Kilteragh, Dooradoyle', 'Limerick', 182625, 2, 2, 6, 4, 2500, 'C2',
        'We are delighted to bring this spacious semi-detached family home to the market. No 12 Killard is beautifully presented family home and benefits from a delightful landscaped back garden. It is very well-proportioned and comes to the market in turn-key condition. It is an ideal purchase for any first time buyer or family. Alternatively, the property could be a lucrative investment. Viewing of this well presented family home is recommended without delay. Kilteragh is so well located off the main Dooradoyle Road within walking distance of Crescent Shopping Centre, Crescent Comprehensive school and many sports and leisure facilities. The Regional Hospital is also within easy striking distance. Limerick city with its many facilities is also only approx. 4kms away with regular bus routes. ',
        '80x120', 1, 2, 4, '182625.jpg', 149000, '2016-09-07'),
       (32, '12 Mount Rochfort Close', 'Co. Dublin', 854605, 8, 1, 4, 1.5, 2000, 'B2',
        'Hardwood trim throughout. This is a real gem. Three-seasons back porch, large yard, finished basement, and third-floor office make this a winner!',
        '80x120', 1, 2, 2, '854605.jpg', 279900, '2021-01-26'),
       (2, '26 Lawrence Hill', 'Derry', 598795, 5, 1, 7, 4, 2500, '0',
        'This elegant red-brick terrace house, dating from the early 20th century, has many original period features including floorings, decorative plasterwork, staircases, woodwork and fireplaces. While the property is currently equipped and licensed for multiple occupation, and provides an excellent opportunity for an investor in the rental market, it would take only a nominal amount of work to turn it back into a beautiful and stylish family home. Lawrence Hill is a much sought-after quiet residential area within easy walking distance of the city centre, and adjacent to the University of Ulster''s Magee College campus.',
        '80x120', 2, 2, 2, '598795.jpg', 129900, '2019-10-05'),
       (1, '88 Lagmore Glen', 'Befast', 784571, 1, 2, 3, 2, 1900, '',
        ...
        '80x110', 1, 1, 2, '784571.jpg', 200800, '2020-11-01'),
       (28, '46 Newtown Park, Annacotty', 'Limerick', 874524, 1, 2, 3, 2, 780, 'A3',
        ...
        '85x80', 3, 2, 2, '874524.jpg', 180000, '2021-03-01');

--
-- Dumping data for table `propertytypes`
--

 INSERT INTO propertytypes (type_Id, p_Type)
 VALUES (1, 'Residential-single'),
        (2, 'Residential-multi'),
        (3, 'Commercial');
...
--
 ...
 INSERT INTO `styles` (`style_Id`, `p_Style`)
 VALUES (1, 'Bungalow'),
        (2, 'Semi Detached'),
        (3, 'Detached '),
        (4, 'Cottage'),
